<x-app-layout>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-cyan-50 px-4 py-8">
        <div class="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">Update your item details</p>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data" class="p-8 space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="condition"
                                ...
                                <option value="new" {{ old('condition', $product->condition) == 'new' ? 'selected' : '' }}>Brand New</option>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="price_per_day" value="{{ old('price_per_day', $product->price_per_day) }}"
                                   class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 focus:bg-blue-50/50 transition-all"
                                   placeholder="0.00"
                                   min="0"
                                   required>
                    ...
                    <div>
                        ...
                        @if($product->image_url)
                            <div class="mb-4">
                                ...
                                <div class="mt-2 relative w-40 h-40 rounded-xl overflow-hidden border border-gray-200">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-blue-300 transition-colors cursor-pointer bg-gray-50/50">
                            ...
                            <label for="image-upload" class="cursor-pointer">
                                <span class="text-gray-700 font-medium text-sm">Click to upload new image</span>
                        ...
                        <p class="text-xs text-gray-500 mt-2">Upload to replace current image (optional)</p>
                    </div>
                </div>
